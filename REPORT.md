...
* Рекурсивно "отбрасывая" голову списка, проходим по нему. Если X - это последний элемент T, то X это последний элемент всего листа. В конце концов T станет списком с одним элементом;
