...
Использование отсечения(!) позволяет создавать взаимоисключающие правила, то есть возможность создать утверждение типа: если А, то В, иначе - С.  
...
Сумма, длина списка вычисляется при помощи стандартных предикатов.
