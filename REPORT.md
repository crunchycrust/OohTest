...
К фактам, связывающим ученика и оценку и находящимся внутри списка, внутри журнала по определённому предмету, нельзя обратиться просто так. А так как в списке можно хранить термины, а не предикаты, то те факты являются терминами. Это значит, что пользоваться ими можно только проходя через весь список. Именно этот обход порождает 'трёхслойные' или более правила, не очень лёгкие для понимания и нахождения ошибок. Если бы вместо журналов успеваемости были факты с предметом, учеником и оценкой, то правила были бы проще.  
